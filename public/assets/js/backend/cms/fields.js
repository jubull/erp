                    ...
                    [
                        ...
                        },
                        {
                            field: 'iscontribute', visible: ['channel', 'page', 'special'].indexOf(Config.source) < 0, title: __('Iscontribute'), searchList: {"1": __('Yes'), "0": __('No')}, formatter: function (value, row, index) {
                                return row.issystem && ["channel_ids", "image", "images", "tags", "price", "outlink", "content", "keywords", "description"].indexOf(row.name) === -1 ? "-" : Table.api.formatter.toggle.call(this, value, row, index);
                            }
                        },
                        ...
                        },
                        {
                            ...
                            formatter: function (value, row, index) {
                                ...
                                if (row.issystem) {
                                    if (['channel', 'page', 'special'].indexOf(Config.source) > -1) {
                                        return '-';
                                    }
